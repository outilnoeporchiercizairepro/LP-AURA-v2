...
const Benefits: React.FC = () => {
  const skills = [
    "Concevoir une architecture IA moderne (RAG, agents, APIs)",
...
Tu ne te contenteras plus d’utiliser des outils. Tu sauras rapidement comment construire des systèmes qui se vendent plusieurs milliers d’euros, en quelques jours, depuis n’importe où.
