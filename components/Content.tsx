  ...
  const tabs: TabContent[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { title: "Communauté Discord Gratuite", description: "Rejoins un Discord actif avec des channels thématiques (IA, N8n, dev, projets) et une communauté soudée pour s'entraider et progresser ensemble." },
