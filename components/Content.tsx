  ...
  const tabs: TabContent[] = [
    {
      ...
      items: [
        ...
        { title: "Offres et prix", description: "Structure des offres IA irrésistibles et défini une tarification premium adaptée à la valeur que tu apportes. Apprends à packager tes compétences pour maximiser tes revenus." },
